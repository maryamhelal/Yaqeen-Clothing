...
const options = {
  definition: {
    ...
    info: {
      ...
      version: '1.0.0',
      description: 'A comprehensive API for Yaqeen Clothing e-commerce platform',
      contact: {
        name: 'Yaqeen Clothing',
        email: 'support@yaqeenclothing.com'
      },
      servers: [
        {
      ...
      schemas: {
        ...
        Message: {
          ...
          properties: {
            ...
            message: { type: 'string', example: 'I would like to know more about your products' },
            createdAt: { type: 'string', format: 'date-time' }
          }
        },
        Tag: {
