...
export default function CollectionPage() {
  ...
  const fetchProducts = async () => {
    ...
    setError("");
    try {
      const result = await productsAPI.getProductsByCollection(collectionName, currentPage, 12);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-pink-50 to-purple-50 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold text-gray-800 capitalize mb-4">{collectionName}</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {loading ? (
          ...
          <div className="text-center py-12">
            <div className="text-gray-500 text-lg">No products found in this collection.</div>
          </div>
        ) : (
          <>
