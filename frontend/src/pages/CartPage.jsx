...
export default function CartPage() {
  ...
  const containerClass = cart.length === 0
    ? "min-h-[40vh] bg-gray-50"
                  ...
                  {cart.map(item => (
                    <div key={item.id} className="p-6 flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-primary-dark font-bold">{item.price.toLocaleString()} EGP</p>
                      </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-t border-gray-200 pt-4">
                    <div className="flex justify-between">
                      ...
                      <span className="text-lg font-bold text-primary-dark">{subtotal.toLocaleString()} EGP</span>
                    </div>
                  </div>
                </div>
                <button
